...
- 美術：MVP 用程式美術（純色塊 / 幾何 / 文字），不載入外部圖檔。日後替換正式美術／加音效的免費素材來源見 [`docs/assets-resources.md`](../../assets-resources.md)，授權標示見根目錄 [`CREDITS.md`](../../../CREDITS.md)。
...
- （選配）替換正式美術／加入音效：素材來源見 [`docs/assets-resources.md`](../../assets-resources.md)（以免費、CC0 優先），取用 CC-BY 素材時務必登記到根目錄 [`CREDITS.md`](../../../CREDITS.md)。
